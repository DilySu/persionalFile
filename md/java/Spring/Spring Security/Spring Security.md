...
```java
ConfigurableApplicationContext run = SpringApplication.run(SecurityJwtStudyApplication.class, args);
Evaluate--->run.getBean(DefaultSecurityFilterChain.class) // 计算中输入这行，查看默认过滤器
```
...
![image-20220518204530](img/image-20220518204530.png)

![image-20220518204554](img/image-20220518204554.png)
...
~~~~xml
		...
		<!--使用JWT时遇到ClassNotFoundException异常，可能是JDK版本太高，故配置一下这个依赖 jaxb-api-->
        <dependency>
